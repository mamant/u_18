$(document).ready(function() {
	...
	$(document).on('click', 'a.mp_more_btn', function (e) {
		e.preventDefault();
		$(this).hide();
		$(document).find('.mp_more_text_second').show();
        $(document).find('.mp_hide_btn').show();
        return false;
    });
    $(document).on('click', 'a.mp_hide_btn', function (e) {
        e.preventDefault();
        $(this).hide();
        $(document).find('.mp_more_text_second').hide();
        $(document).find('.mp_more_btn').show();
        return false;
    });
